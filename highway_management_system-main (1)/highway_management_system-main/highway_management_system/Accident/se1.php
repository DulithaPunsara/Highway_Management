...
<div class="margin">
    ...
    <form method="post">
        ...
        <label for="date">Date of the Accident:</label>
        ...
        <tbody>
            ...
            <tr>
                <form method="post">
                    ...
                    <td><input type="text" name="newacclocation" value="<?= htmlspecialchars($vehicle['acclocation']) ?>"></td>
...
<div class="summary">
    <h2>Summary</h2>
    <p>Total Number of Accidents: <?= $linkedList2->countAllVehicles() ?></p>
</div>
            </div>
