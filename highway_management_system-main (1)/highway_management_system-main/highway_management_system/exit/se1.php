<div class="margin">
    ...
    <!-- Summary  -->
    <div class="summary">
        <span>Number of Heavy vehicle: <?= htmlspecialchars($carCount1) ?></span>
        <span class="sum_2">Number of Lite vehicle: <?= htmlspecialchars($truckCount1) ?></span>
    </div>
